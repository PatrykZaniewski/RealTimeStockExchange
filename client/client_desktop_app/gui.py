...
class MainWindow(QMainWindow):
    ...
    def init_assets(self, asset_name: str) -> QHBoxLayout:
        ...
        buy = QPushButton("BUY!")
        buy.pressed.connect(lambda: self._process_order(asset_name, amount, buy_price, OrderType.BUY))
        sell = QPushButton("SELL!")
        sell.pressed.connect(lambda: self._process_order(asset_name, amount, sell_price, OrderType.SELL))
