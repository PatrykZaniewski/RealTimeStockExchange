...
class ProcessingResults:
    ...
    broker_facade_messaging: Optional[int] = field(default=None)
    ...
    broker_core_order_messaging: Optional[int] = field(default=None)
    ...
    broker_order_executor_messaging: Optional[int] = field(default=None)
    ...
    stock_order_collector_messaging: Optional[int] = field(default=None)
    ...
    stock_core_messaging: Optional[int] = field(default=None)
    ...
    broker_order_status_collector_messaging: Optional[int] = field(default=None)
    ...
    broker_core_status_messaging: Optional[int] = field(default=None)
    ...
    broker_data_streamer_messaging: Optional[int] = field(default=None)
